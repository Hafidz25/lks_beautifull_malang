        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content mt-24">
                <div>
                    ...
                    <Link href='' className="link link-hover">Destination</Link>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    <img src='/img/logo.png' className='w-20 h-auto' />
                    <p>Beautifull Malang <br />Copyright © 2023 - All right reserved</p>
                </div>
